...
- (IBAction)buttonPressed:(UIButton *)sender {
    ...
    //set the badge title to reflect number of calculated glasses
    NSString *itemTitle = [NSString stringWithFormat:NSLocalizedString(@"%.0f",nil) ,numberOfWineGlassesForEquivalentAlcoholAmount];
